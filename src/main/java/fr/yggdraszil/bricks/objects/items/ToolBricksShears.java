package fr.yggdraszil.bricks.objects.items;
...
public class ToolBricksShears extends ShearsItem
{
    public ToolBricksShears(Properties p_i48471_1_)
    {
        super(p_i48471_1_);
    }
    ...
    public net.minecraft.util.ActionResultType interactLivingEntity(ItemStack stack, net.minecraft.entity.player.PlayerEntity playerIn, LivingEntity entity, net.minecraft.util.Hand hand)
    {
        ...
        if(entity instanceof net.minecraftforge.common.IForgeShearable)
        {
            ...
            {
                java.util.List<ItemStack> drops = target.onSheared(playerIn, stack, entity.level, pos, net.minecraft.enchantment.EnchantmentHelper.getItemEnchantmentLevel(net.minecraft.enchantment.Enchantments.BLOCK_FORTUNE, stack));
